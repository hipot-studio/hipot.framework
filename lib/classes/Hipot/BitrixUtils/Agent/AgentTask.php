...
final class AgentTask
{
	...
	/**
	 * Create agent run string in Bitrix queue.
	 */
	public function createRunString(): string
	{
		return AgentHelper::createName($this->class, $this->constructorArgs, $this->callChain);
	}
}
