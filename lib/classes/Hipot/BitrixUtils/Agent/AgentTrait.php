 ...
 * 1. Bitrix launches static method `ClassName::agent()->%method%()`. Your agents should be registered
 * in the same format: `\Vendor\Package\ClassName::agent()->%method%();`.
...
trait AgentTrait
{
	 ...
	 *
	 * Bitrix calls this method to run agent. All arguments from this method should
