...
return [
	...
	'cache' => [
		'value' => [
			...
			'sid'      => $sid,
			// Функционал "блокирующего режима" кеширования. При этом кеш генерируется одним потоком, а остальные получают старое значение
			// до его обновления в кеше. Или если его нет то, как и раньше каждый поток генерирует данные.
			'use_lock' => true
		],
		/*
		'value' => [
	...
	'cache_flags' => [
		'value' => [
			...
			"b_iblock_property_max_ttl" => 86400,
			"b_iblock_min_ttl"          => 68400,
			"b_iblock_max_ttl"          => 86400,
	...
	'http_client_options' => [
		'value' => [
			...
			'useCurl'                   => true,
			//'curlLogFile'               => '/home/bitrix/logs/http_client_curl.log' // opt
		],
		'readonly' => false,
	],
	...
	'smtp' => [
		'value'	=> [
			'enabled'	=> true,
			'debug'		=> false,	// opt
			//'log_file'	=> '/home/bitrix/logs/mailer.log' // opt
		]
	],
